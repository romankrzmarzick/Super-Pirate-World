...
class level:
    def __init__(self, tmx_map, level_frames, audio_files, storage, switch_stage):
        ...
        self.all_sprites = AllSprites(
            ...
            clouds={'large' : level_frames['large_cloud'], 'small' : level_frames['small_clouds']},
    ...
    def setup(self, tmx_map, level_frames):
        ...
        for obj in tmx_map.get_layer_by_name("Items"):
            Item(obj.name, (obj.x + TILE_SIZE / 2, obj.y + TILE_SIZE / 2), level_frames['items'][obj.name], (self.all_sprites, self.item_sprites), self.storage)
            ...
            for row in range(rows):
                for col in range(cols):
                    ...
                    if row == 0:
                        ...
                        Sprite(pos=(x, y), surf=level_frames['water_body'], groups=self.all_sprites, z=Z_LAYERS["water"])
